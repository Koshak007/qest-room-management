...
sequenceDiagram
    ...
    Клиент->>Система: Выбирает квест и время
    Система-->>Клиент: Показывает доступные слоты

    Клиент->>Система: Создаёт бронирование
    Система-->>Клиент: Подтверждает бронь

    Клиент->>Система: Оплачивает
    Система-->>Клиент: Выдаёт чек

    Система->>Сотрудник: Назначает на квест
    Сотрудник-->>Система: Принимает

    Сотрудник->>Клиент: Проводит квест
    Клиент-->>Сотрудник: Оставляет отзыв
```
